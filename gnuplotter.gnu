...
ofileName = "../Plots/entropyLimit.png"
ifileName = "../Data/entropy.csv"
set datafile separator ','
...
plot ifileName using 1:2 ls 1 title "", 4.6 ls 3 title "Asymptote at approximately 4.6"
...
# set key
# #plot ifileName2 using 1:2 title "ln(R(t)) for 100x100" ls 1 , ifileName3 title "ln(R(t)) for 200x200" ls 4
# # LINEAR REGRESSION FIT FOR LOGARITHMIC PLOT
# f(x) = m*x + b
# fit f(x) ifileName5 using 1:2 via m,b # stores value of m and b
# # M = 200
# # m = -0.00222028 ,b = 0.941217  -> t = 125/2:1500
# set title "Relaxation of the Entropy to Equilibrium (M = 200)"
# plot ifileName5 using 1:2 title "ln(R(t))" ls 1 with lines, f(x) title "Linear Fit" ls 3 with lines

# # LINEAR REGIME FOR LOG M = 100
# set output ofileName3
# f(x) = m*x + b
# fit f(x) ifileName6 using 1:2 via m,b # stores value of m and b
# # M = 100
# # m = -0.00849316 ,b = 0.845499   -> t = 60:300
# # m = -0.00835402 ,b =0.845499  -> t = 50:400
# set title "Relaxation of the Entropy to Equilibrium (M = 100)"

# plot ifileName6 using 1:2 title "ln(R(t))" ls 1 with lines, f(x) title "Linear Fit" ls 3 with lines